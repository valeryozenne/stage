...
namespace Gadgetron {
    ...
    class EXPORTGADGETSMRICORE_LIRYC GenericEmptyTestGadget : public GenericReconDataBase
    {
    public:
        GADGET_DECLARE(GenericEmptyTestGadget);

        typedef GenericReconDataBase BaseClass;
        typedef hoNDKLT< std::complex<float> > KLTType;

        GenericEmptyTestGadget();
        ~GenericEmptyTestGadget();
